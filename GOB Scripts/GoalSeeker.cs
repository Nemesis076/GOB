...
public class GoalSeeker : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        mActions[1].targetGoals.Add(new Goal("Game", +1f));
        ...
        mActions[2].targetGoals.Add(new Goal("Game", +2f));
        ...
        mActions[4].targetGoals.Add(new Goal("Game", +3f));

        mActions[5] = new Action("visit the Computer");
        mActions[5].targetGoals.Add(new Goal("Eat", +2f));
        mActions[5].targetGoals.Add(new Goal("Sleep", +2f));
        mActions[5].targetGoals.Add(new Goal("Game", -4f));
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.E))
        {
            ...
            if ((bestThingToDo.name == "eat some raw food") || (bestThingToDo.name == "eat a snack") || (bestThingToDo.name == "drink a soda"))
            {
                player.transform.position = new Vector3(2.3f, 4f, 10f);
            }
            if((bestThingToDo.name == "sleep in the bed") || (bestThingToDo.name == "sleep on the sofa"))
            {
